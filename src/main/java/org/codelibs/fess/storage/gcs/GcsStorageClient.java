 ...
 */
package org.codelibs.fess.storage.gcs;
 ...
 *
 * <p>Registered as the LastaDi component {@code gcsStorageClient} by fess_storage++.xml, which is
 * how {@code storage.type=gcs} reaches it. It lived in Fess itself until 15.9; it moved here with
 * the Google Cloud Storage SDK so that the distribution does not carry 17 MiB for a backend most
 * installations do not use.</p>
 */
